    ...
    <div id="main" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-green-600"><i
                                    class="fas fa-sort-amount-up fa-2x fa-inverse"></i></div>
                        </div>
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-yellow-600"><i
                                    class="fas fa-sort-amount-down-alt fa-2x fa-inverse"></i></div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                            <h2 class="font-bold uppercase text-gray-600">Produto Mais Barato</h2>
                            <p class="font-bold text-3xl">
                                {{ $produtoMaisBarato ? json_decode($produtoMaisBarato)->name . ' - R$ ' . number_format(json_decode($produtoMaisBarato)->price, 2, ',', '.') : 'Não existe produto' }}
                                <span class="text-yellow-600"><i class="fas fa-caret-down"></i></span>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-green-600"><i class="fas fa-inbox fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                            <h2 class="font-bold uppercase text-gray-600">Qtd de Produtos Cadastrados</h2>
                            <p class="font-bold text-3xl">{{ $totalProduto }} <span class="text-green-500"><i
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-indigo-600"><i class="fas fa-inbox fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            ...
                            <p class="font-bold text-3xl">{{ json_decode($produtoMaisVendido)[0]->name ?? 'Nenhuma Venda Realizada' }} <span
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                <!--Metric Card-->
                <div
                    class="bg-gradient-to-b from-green-200 to-limepink-100 border-b-4 border-green-500 rounded-lg shadow-xl p-5">
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-green-600"><i class="fas fa-tasks fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                            <h2 class="font-bold uppercase text-gray-600">Total de Pedidos <small>(abertos e
                                    fechados)</small></h2>
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                <!--Metric Card-->
                <div
                    class="bg-gradient-to-b from-yellow-200 to-yellow-100 border-b-4 border-yellow-500 rounded-lg shadow-xl p-5">
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-yellow-600"><i class="fas fa-tasks fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-pink-600"><i class="fas fa-tasks fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        ...
                        <div class="flex-1 text-right md:text-center">
                            ...
                            <p class="font-bold text-3xl">Nº
                                {{ $pedidoPrice ? json_decode($pedidoPrice)->id . ' - R$ ' . number_format(json_decode($pedidoPrice)->price, 2, ',', '.') : 'Não existe o pedido' }}
            ...
            <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                <div
                    ...
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink pr-4">
                            <div class="rounded-full p-5 bg-blue-600"><i class="fas fa-tasks fa-2x fa-inverse"></i>
                            </div>
                        </div>
                        <div class="flex-1 text-right md:text-center">
                            <h2 class="font-bold uppercase text-gray-600">Menor Pedido em R$</h2>
                            <p class="font-bold text-3xl">Nº
                                {{ $pedidoCusto ? json_decode($pedidoCusto)->id . ' - R$ ' . number_format(json_decode($pedidoCusto)->price, 2, ',', '.') : 'Não existe o pedido' }}
                            </p>
                        </div>
                    </div>
                </div>
